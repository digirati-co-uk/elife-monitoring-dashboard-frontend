/* eLife - v0.0.1 */
/* https://github.com/elifesciences/elife-dashboard */
  ...
  renderCalendar: function() {
    $('#schedule-calendar').fullCalendar({
      ...
      viewRender: function(view, element) {
        ...
        if(app.scheduled.currentViewType == 'month') {
          // if the current 'start' date of the selected month is not the same as the actual month then set the app.scheduled.calendarDate to the first of the proper month
          ...
          if(currentStartMonth != currentMonth) {
            app.scheduled.calendarDate = moment(view.title, 'MMMM YYYY').startOf('month').format('DD-MM-YYYY');
          }
          else {
